	...
	<body>
		<div  class="page page-settings">
			<header class="bar bar-nav">
				...
				<a  onclick="$.editDetail('add')" class="button button-link pull-right">
					<span  class="icon icon-plus"></span> 新增
				</a>
			</header>
			<div class="content">
				<div class="bar bar-header-secondary">
					<div class="searchbar">
						...
						<div class="search-input">
							...
							<input type="search" id='search' placeholder='关键字过滤' />
						</div>
					</div>
				</div>
		...
		/*截取URL中的参数值,为公共函数*/
						...
						success: function(d) {
							...
							if(data.code == "0000") {
								...
								data.data.forEach(function(arg, index) {
									tempStr.push('<li  id="user' + arg.id + '" onclick="$.editDetail(\'' + arg.id + '\',bizManage);"  class="swipeout outter">');
			...
			$.editDetail = function(itemID,bizManage){
				window.location.href="http://localhost/hsylglxt/admin.php/index/editDetail.html?itemID="+itemID+'&bizManage='+bizManage;
			}
			/*过滤的方法通用*/
