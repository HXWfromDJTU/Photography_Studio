<?php if (!defined('THINK_PATH')) exit();?><html>
	...
	<head>
		...
		<link rel="shortcut icon" href="/hsylglxt/View/Admin/Public/css/icon">
		...
		<link rel="apple-touch-icon" href="/hsylglxt/View/Admin/Public/img/apple-touch-icon-114x114.png">
		...
		<style>
			...
			.content {
				background-image: url(/hsylglxt/View/Admin/Public/img/bg-img.png);
			...
			.content.register-content {
				background-image: url(/hsylglxt/View/Admin/Public/img/bg-register.png);
				background-size: cover;
			}
	...
	<body>
							...
							<li>
								<div href="#" class="item-content user-head-box">
									<div class="item-media">
										<img src="/hsylglxt/View/Admin/Public/img/icon.png">
									</div>
								</div>
							</li>
						</ul>
								...
								<li>
									<div class="item-content sex-box">
										<div id="women" class="img-box active">
											<img src="/hsylglxt/View/Admin/Public/img/xinniang.png" style="margin-right:-2.0rem" />
										</div>
										<div id="man" class="img-box">
											<img src="/hsylglxt/View/Admin/Public/img/xinlang.png" style="margin-left:-2.0rem" />
										</div>
									</div>
								</li>
		...
		<script src="/hsylglxt/View/Admin/Public/js/public.js"></script>
		<script src="/hsylglxt/View/Admin/Public/js/index.js"></script>
		<script>
